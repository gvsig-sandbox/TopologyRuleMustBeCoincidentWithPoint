    ...
    try:
      ...
      if theDataSet2.getSpatialIndex() != None:
        ...
        for reference in theDataSet2.query(point):
            ...
            if (otherPoint!=None and not pointTolerance.intersection(otherPoint)):
              error = pointTolerance.disjoint(otherPoint)
              report.addLine(self,
                theDataSet1,
                theDataSet2,
                point,
      ...
      pass
def main(*args):
  # testing class m = MustBeCoincidentWithPointRule(None, None, 3, None)
  print "* Executing MustBeCoincidentWithPoint RULE main."
  tm = TopologyLocator.getTopologyManager()
  
  from mustBeCoincidentWithPointRuleFactory import MustBeCoincidentWithPointRuleFactory
  a = MustBeCoincidentWithPointRuleFactory()
